...
<div id="sendpulse-popup" class="fixed-bottom">
	...
	<div class="row dt-sendpulse-popup-text justify-content-start" id="dt-sendpulse-popup-first">
                ...
                <div class="form-row add-margin-top-bottom">
                    <div class="col last-col">
                        <div class="dt-form-agree-terms">
                            ...
                            <label class="form-check-label" for="terms_check">I agree with <a target=_new href="<?php echo get_site_url().'/soshace-privacy-policy/' ?>">Privacy Policy</a></label>
